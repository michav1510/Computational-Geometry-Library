 ...
 * point p_3 
 */
static double Orient_Pred(const Point2d& p_1, const Point2d& p_2, const Point2d& p_3);	
...
*/
static bool Edg_Inters_Pred(const double p1_x, const double p1_y, const double p2_x, const double p2_y, const double p3_x, const double p3_y, const double p4_x, const double p4_y);
 ...
 * @returns true if the edges intersect and false otherwise
 */
static bool Edg_Inters_Pred(const Point2d& p_1, const Point2d& p_2, const Point2d& p_3, const Point2d& p_4);
 ...
 * @returns true if the edges intersect and false otherwise
 */
static bool Edg_Inters_Pred(const Edge2d& ed_1, const Edge2d& ed_2);
